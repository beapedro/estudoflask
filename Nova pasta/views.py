...
def amigos(nickname):
   ...
   amigos = Amigos.query.filter(or_(Amigos.amigo1 == nickname, Amigos.amigo2 == nickname)).all()

   amigo_pfp = Amigos.amigo1
...
def solicitacao():
   ...
   convite = Amigos(
                    ...
                    amigo1=amigo1, amigo2=amigo2, 
                    confirmacao = 0, 
                    mensagem = mensagem,
                    datainicio = datetime.utc.now()
                    )
